import { MULT_CHOICE_GRID } from '../../../model/survey/questionTypes';
...
import MultChoiceGridQuestion from '../../../model/survey/question/MultChoiceGridQuestion';
...
class MultChoiceGridEditState extends EditState {
  constructor(
    ...
    super(MULT_CHOICE_GRID, isRequired, mainQuestionText, id);
  ...
  clone() {
    return new MultChoiceGridEditState(
      this.isRequired,
      this.isAllRequired,
      this.text,
      this.isOneToOne,
...
export default MultChoiceGridEditState;
