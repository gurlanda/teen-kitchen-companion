import TimeQuestion from 'src/model/survey/question/TimeQuestion';
...
export default class TimeInputState extends InputState {
  ...
  constructor(
    ...
    super(Qtypes.TIME, isRequired, questionText, questionHeader, questionId);

    if (
      !(questionHeader instanceof String || typeof questionHeader === 'string')
    ) {
      throw new TypeError(
        "In constructor TimeInputState(): Argument passed into parameter 'questionHeader' is not of type String"
      );
    }
    ...
    if (
      ...
      throw new TypeError(
        "In constructor TimeInputState(): Argument passed into parameter 'value' is of incorrect type"
      );
    }
  ...
  static fromQuestion(dateTime) {
    ...
    if (
      !(dateTime instanceof TimeInputState || dateTime instanceof TimeQuestion)
    ) {
      console.log(
        'In static TimeInputState.fromQues(): Parsing error. Passed-in argument:'
      );
      console.log(dateTime);
      throw new TypeError(
        "In static TimeInputState.fromQues(): Argument passed into parameter 'dateTime' is not of type TimeInputState or TimeQuestion"
      );
    }
  ...
  clone() {
    return TimeInputState.fromQues(this);
  }

  createSetDanger(isDanger) {
    if (!(isDanger instanceof String || typeof isDanger === 'boolean')) {
      throw new TypeError(
        'In TimeInputState.createSetDanger(): Argument not of type Boolean'
      );
    }
  ...
  createSetValueDate(date) {
    return (oldState) => {
      ...
      if (date instanceof Date) {
        ...
        throw new TypeError(
          'In TimeInputState.createSetValue(): Argument not of type Date or Number, or null'
        );
      }
  ...
  createSetValueManual(year, monthIndex, day, hoursIndex, minutes) {
    return (oldState) => {
      ...
      if (
        ...
        throw new TypeError(
          'In TimeInputState.createSetValue(): One or more arguments is not a valid type'
        );
      }
