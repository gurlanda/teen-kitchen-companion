...
const Gracie: StoryData = {
  header: 'Gracie with a big smile!',
  img: img,
  alt: 'Gracie with a big smile as she stirs a pot.',
  content: `"I am a volunteer at Teen Kitchen Project during the summers when I have
