...
const Alejandro: StoryData = {
  header: 'Meet Alejandro!',
  img: img,
  alt: 'Alejandro smiling as he peels an egg in the kitchen.',
  content: `"Hi! My name is Alejandro Ramirez. I'm a sophmore at Watsonville High
