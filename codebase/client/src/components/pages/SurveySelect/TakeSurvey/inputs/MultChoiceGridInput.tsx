...
import SurveyInputContext from 'src/context/SurveyInput/SurveyInputContext';
import QuestionInputState from 'src/model/InputState/QuestionInputState';

const MultChoiceGridInput: React.FC<{ question: QuestionInputState }> = ({
  question,
}) => {
  ...
  const onChange = (selectedRow: string, selectedOptId: string) => {
    surveyContext.useQuestionReducer(
      id,
      QuestionInputState.createSetMcGridOption(selectedRow, selectedOptId)
    );
  };
...
export default MultChoiceGridInput;
