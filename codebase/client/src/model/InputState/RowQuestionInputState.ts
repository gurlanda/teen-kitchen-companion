...
export default class RowQuestionInputState implements Clonable<RowQuestionInputState>, Identifiable {
  private rowQuestion: RowQuestion;
  options: OptionInputState[];
  get text(): string { return this.rowQuestion.text; }
  get id(): string { return this.rowQuestion.id; }
  get question(): RowQuestion { return this.rowQuestion.clone(); }

  constructor(rowQuestion: RowQuestion, options: OptionInputState[] | Option[]) {
  ...
  static fromResponse(rowQuestion: RowQuestion, options: OptionInputState[] | Option[], resp: Response): RowQuestionInputState {
