...
export default class ImgOptInputState implements Clonable<ImgOptInputState>, Selectable, Identifiable {
  readonly scaleVal: ScaleValue;
  isSelected: boolean;
  get id(): string { return this.scaleVal.path; }
  get value(): number { return this.scaleVal.value; }
  get imgPath(): string { return this.scaleVal.path; }
